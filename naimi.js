...
const { WEBMBufferToVideoBuffer } = require('./lib/myfunc2')
...
if (!('nsfw' in karutaset)) karutaset.nsfw = false
...
● Money : ${checkuangUser(sender)}
● Limit : ${isPremium ? '∞️' : `${checklimitUser(sender)}`}
● Library : Baileys MD
● Language : JavaScript
...
● _*NSFW MENU*_
• ${prefix}nsfwmenu
• _turn on nsfw first in settings use ${prefix}setting_
`
//document randomizer
...
*Terimakasih telah mendapatkan diri ke database, berikut adalah infonya*\n\n*●Nama : ${pushname}*\n*●Nomor : ${sender.split('@')[0]}*\n*●Pengguna : ${register.length}*\n*●SN : ${serialUser}*\n\n*Gunakan bot sewajarnya*`
...
karutamd = fs.readFileSync('./karuta/karuta.png')
let txtit = anuuh
naimi.sendMessage(from, { caption: anuuh, image: Imgnah, templateButtons: btn886, footer: `${setting.botFooter}`, mentions: [sender] })
...
reply(`*「 PREMIUM ADDED 」*\n\n➸ *ID*: ${prmi}`)
break
case 'addlimit': case 'addlim':
if (!isOwner) return reply(mess.owner)
const limitrnwanttobecleans = checklimitUser(sender)
console.log('Then '+checklimitUser(sender))
confirmlimit(sender, limitrnwanttobecleans)
console.log('Now '+checklimitUser(sender))
console.log(sender)
const teksn1 = q.split(" ")[0]
const teksn2 = q.split(" ")[1]
if (!teksn1) return reply(`contoh ${prefix}addlimit 6283141953754_(nomor)_ 10_(limit)_`)
if (isNaN(teksn1)) return reply('harus berupa nomor')
if (isNaN(teksn2)) return reply('tulis berapa limitnya setelah spasi')
userthattext = `${teksn1}@s.whatsapp.net`
const checklimitinaddlimit = checklimitUser(userthattext)
if ( checklimitinaddlimit === undefined ) { reply('Error mungkin nomornya gak ada di database') }
console.log(checklimitUser(userthattext))
addlimitUser(userthattext, teksn2)
console.log(checklimitUser(userthattext))
console.log(teksn1, teksn2)
...
const buttonstod = [{buttonId: `${prefix}welcome on`, buttonText: {displayText: 'On'}, type: 1},{buttonId: `${prefix}welcome off`, buttonText: {displayText: 'Off'}, type: 1}]
const patri = {
text: `Silahkan pilih salah satu di bawah`,
footer: `${setting.botFooter}`,
buttons: buttonstod,
headerType: 1
}
...
reply('*「 ANTILINK DI AKTIFKAN 」*\n\nYang Mengenai Link Group Bakal Ke Kick!')
	} else if (args[0] === 'off') { if (!isAntilink) return reply(`*Belum nyala!*`)
   anu = antilink.indexOf(from)
   antilink.splice(anu, 1)
fs.writeFileSync('./database/group/antilink.json', JSON.stringify(antilink))
reply('*「 ANTILINK DI NONAKTIFKAN 」*')
	} else {
const buttonstod = [{buttonId: `${prefix}antilink on`, buttonText: {displayText: 'On'}, type: 1},{buttonId: `${prefix}antilink off`, buttonText: {displayText: 'Off'}, type: 1}]
const patri = {
text: `Silahkan pilih salah satu di bawah`,
footer: `${setting.botFooter}`,
buttons: buttonstod,
...
quickReplyButton: {
 ...
 naimi.send5ButImg(i, txt, ` © ${setting.botName}`, karutamd, btn)
    }
...
title: "Nsfw Setting",
rows: [
{title: "On", rowId: `setnsfw nsfwon`, description: `Klik Untuk Menghidupkan Nsfw`},
{title: "Off", rowId: `setnsfw nsfwoff`, description: `Klik Untuk Mematikan Nsfw`}
]
},
{
title: "AntiLink Setting",
rows: [
{title: "On", rowId: `.antilink on`, description: `Klik Untuk Menghidupkan Anti Link`},
{title: "Off", rowId: `.antilink off`, description: `Klik Untuk Mematikan Anti Link`}
]
},
{
title: "Welcome Setting",
rows: [
{title: "On", rowId: `.welcome on`, description: `Klik Untuk Menghidupkan Welcome`},
{title: "Off", rowId: `.welcome off`, description: `Klik Untuk Mematikan Welcome`}
]
},
{
title: "Next Features",
rows: [
{title: "Soon", rowId: `donate`, description: `soon`}
]
}
]
naimi.sendListMsg(m.chat, `Hallo ${pushname} ${ucapanWaktu}\nPilih di bawah`,`${setting.botFooter}`, `*Setting*`, `Click Here`, secte, m)
}
break
case 'setnsfw':
if (!isOwner) return reply(mess.owner)
nsfw = db.settings[botNumber]
if (args[0] === 'nsfwon'){
nsfw.nsfw= true
reply('*「 NSFW DI AKTIFKAN 」*')
console.log(nsfw)
} else if (args[0] === 'nsfwoff'){
nsfw.nsfw = false
reply('*「 NSFW DI MATIKAN 」*')
console.log(nsfw)
} else {
let sections = [
{
title: "CHANGE NSFW PREFERENCE",
rows: [
{title: "On", rowId: `setnsfw nsfwon`, description: `Klik Untuk Menghidupkan Nsfw`},
{title: "Off", rowId: `setnsfw nsfwoff`, description: `Klik Untuk Mematikan Nsfw`}
]
...
naimi.sendListMsg(m.chat, `Pilih salah satu di bawah`, `${setting.botFooter}`, '*Change Preference*', `Click Here`, sections, m)
console.log(nsfw)
}
break
case 'setmenu':
...
naimi.sendListMsg(m.chat, `Pilih salah satu mode menu di bawah`, `${setting.botFooter}`, '*CHANGE MENU*', `Click Here`, sections, m)
}
console.log(setbot)
break
...
quickReplyButton: {
 ...
 karutamd = fs.readFileSync('./karuta/karuta.jpg')
 let txt = `「 Broadcast Bot 」\n\n${text}`
 naimi.send5ButImg(yoi, txt, ` © ${setting.botName}`, karutamd, btn)
}
...
title: "Title 1",
rows: [
{title: "Menu 1", rowId: `cmdmenu`, description: `Decs Menu 1`}
]
},
{
title: "Title 2",
rows: [
{title: "Menu 2", rowId: `cmdmenu`, description: `Decs Menu 2`}
]
}
]
naimi.sendListMsg(m.chat, `Hallo ${pushname} ${ucapanWaktu}\nPilih salah satu menu di bawah`,`${setting.botFooter}`, `*LIST MENU*`, `Click Here`, secte, m)
break
case 'command':
  let sections = [
{
...
{title: "𝗡𝗦𝗙𝗪 𝗠𝗘𝗡𝗨", rowId: `nsfwmenu`, description: `Menampilkan daftar nsfw menu`}
]
},
  {
...
naimi.sendListMsg(m.chat, `Hallo ${pushname} ${ucapanWaktu}\nPilih salah satu menu di bawah`,`${setting.botFooter}`, `*LIST MENU*`, `Click Here`, sections, m)
///////MENU
break
case 'cerpenmenu':
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
case 'nsfwmenu':
nsfw = db.settings[botNumber]
 if (!nsfw.nsfw) return reply(mess.nsfw)
 if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
 if (isBan) return reply(mess.banned)
 if ( checklimitUser(sender) <= 0) return reply(limitabis) 
...
if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted:ftex})
 if (args.length < 1) return reply(`Penggunaan ${prefix + command} 6283141953754|Hallo`)
nom = q.split("|")[0]
nom2 = q.split("|")[1]
...
naimi.sendMessage(m.chat, { image: { url: anu }, caption: `*${setting.botFooter}*\n\nJangan lupa donet :)` }, { quoted: m })
 }
break
case '3dbox':
  if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted:ftex})
if (!q) return reply(`Example : ${prefix + command} Specstor`) 
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
...
maker.textpro("https://textpro.me/3d-box-text-effect-online-880.html", [
    `${q}`,])
.then((data) => naimi.sendMessage(m.chat, { image: { url: data }, caption: `*${setting.botFooter}*\n\nJangan lupa donet :)` }, { quoted: m }))
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
if(!q) return reply(`Penggunaan ${prefix + command} Specstor|Md`)
reply(mess.wait)
teks1 = q.split("|")[0]
teks2 = q.split("|")[1]
...
case 'cleanlimit':
if (!isOwner) return reply(mess.owner)
const limitrnwanttobeclean = checklimitUser(sender)
console.log('Then '+checklimitUser(sender))
confirmlimit(sender, limitrnwanttobeclean)
console.log('Now '+checklimitUser(sender))
console.log(sender)
break
case 'gel': case 'gelbooru': {
nsfw = db.settings[botNumber]
 if (!q) return reply(`Example : ${prefix}gel sex,blonde hair,uncensored,cum`)
 if (!nsfw.nsfw) return reply(mess.nsfw)
 if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
 if (isBan) return reply(mess.banned)
 if ( checklimitUser(sender) <= 0) return reply(limitabis) 
 //if (!q) return reply(`Contoh : ${prefix + command} yuri`)*/
  reply(mess.wait)
...
Booru.search('gb', [tags1, tags2, tags3, tags4, tags5, tags6, tags7, tags8, tags9,tags10 ], { limit: 1, random: true }).then(
  posts => {
    for (let post of posts) {
    console.log(post.fileUrl)
    const posta = post.fileUrl
    const tags = post.tags
    const kontol = JSON.stringify(posta)
    console.log(kontol)
...
quickReplyButton: {
displayText: 'Next',
id: `${ prefix + command } ${tags1},${tags2},${tags3},${tags4},${tags5},${tags6},${tags7},${tags8},${tags9},${tags10}` 
}
},
{
quickReplyButton: {
...
const str = kontol.includes('jpeg') || kontol.includes('jpg') || kontol.includes('png')
if (str) {
 naimi.sendMessage(from, { caption: 'Nih', image: { url: post.fileUrl}, templateButtons: buttonsek, footer: `${setting.botFooter}`, mentions: [sender] })
 naimi.sendMessage(from, { react: { text: `🥵`, key: m.key }})
                                    confirmlimit(sender, 1)

} else if (kontol.includes('mp4')) {

naimi.sendMessage(from, { caption: 'Nih', video: { url: post.fileUrl}, gifPlayback: true, templateButtons: buttonsek, footer: `${setting.botFooter}`, mentions: [sender] })
 naimi.sendMessage(from, { react: { text: `🥵`, key: m.key }})
                                    confirmlimit(sender, 1)
} else if (kontol.includes('webm')) {
let gt = getBuffer(kontol)
let gtv = WEBMBufferToVideoBuffer(gt) 
naimi.sendMessage(from, { caption: 'Nih', video: { url: post.fileUrl}, gifPlayback: true, templateButtons: buttonsek, footer: `${setting.botFooter}`, mentions: [sender] })
 naimi.sendMessage(from, { react: { text: `🥵`, key: m.key }})
                                    confirmlimit(sender, 1)

} else if (kontol.includes('gif')) {
let gt = getBuffer(kontol)
let gtv = GIFBufferToVideoBuffer(gt) 

naimi.sendMessage(from, { caption: 'Nih', video: { url: gtv}, gifPlayback: true, templateButtons: buttonsek, footer: `${setting.botFooter}`, mentions: [sender] })
 naimi.sendMessage(from, { react: { text: `🥵`, key: m.key }})
                                    confirmlimit(sender, 1)
}
...
Booru.search('sb', [tags1, tags2, tags3, tags4, tags5, tags6, tags7, tags8, tags9,tags10 || 'cute' ], { limit: 1, random: true }).then(
  posts => {
    for (let post of posts) {
    console.log(post.fileUrl)
    const posta = post.fileUrl
...
Booru.search('r34', [tags1, tags2, tags3, tags4, tags5, tags6, tags7, tags8, tags9,tags10 ], { limit: 1, random: true }).then(
  posts => {
    for (let post of posts) {
    console.log(post)
    console.log(post.fileUrl)
...
Booru.search('kn', [tags1, tags2, tags3, tags4, tags5, tags6, tags7, tags8, tags9,tags10 ], { limit: 1, random: true }).then(
  posts => {
    for (let post of posts) {
    console.log(post)
    console.log(post.fileUrl)
...
Booru.search('xb', [tags1, tags2, tags3, tags4, tags5, tags6, tags7, tags8, tags9,tags10 ], { limit: 1, random: true }).then(
  posts => {
    for (let post of posts) {
    console.log(post)
    console.log(post.fileUrl)
...
naimi.sendMessage(from, { caption: 'Nih', image: { url: result.url}, templateButtons: buttonsek, footer: `${setting.botFooter}`, mentions: [sender] })
 await sleep(10)
 naimi.sendMessage(from, { react: { text: `🥵`, key: m.key }})
                                    confirmlimit(sender, 1)
            console.log(result)
...
break
case 'nbjgif': case 'bjgif': case 'nsfwbjgif': case 'blowjobgif': case 'bj' :
nsfw = db.settings[botNumber]
 if (!nsfw.nsfw) return reply(mess.nsfw)
 if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
 if (isBan) return reply(mess.banned)
...
naimi.sendMessage(from, { caption: 'Nih', video: bjif, gifPlayback: true, templateButtons: buttonsek, footer: `${setting.botFooter}`, mentions: [sender] })
 await sleep(10)
 naimi.sendMessage(from, { react: { text: `🥵`, key: m.key }})
                                    confirmlimit(sender, 1)
break
case 'nvid': case 'nsfwvid': case 'nsfwvideo': case 'hentaivid': case 'hentaivideo': {
 nsfw = db.settings[botNumber]
 if (!nsfw.nsfw) return reply(mess.nsfw)
 if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
 if (isBan) return reply(mess.banned)
...
naimi.sendMessage(from, { caption: listcaptionnvid, video: { url: result912.video_1}, gifPlayback: true, templateButtons: buttonsek, footer: `${setting.botFooter}`, mentions: [sender] })
naimi.sendMessage(from, { react: { text: `🥵`, key: m.key }})
confirmlimit(sender, 1)
}
break
case 'ngif': case 'nsfwgif': {
 nsfw = db.settings[botNumber]
 if (!nsfw.nsfw) return reply(mess.nsfw)
 if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
 if (isBan) return reply(mess.banned)
 if ( checklimitUser(sender) <= 0) return reply(limitabis) 
  reply(mess.wait)
let anu = await fetchJson('https://raw.githubusercontent.com/Specstro/file/Specstor/nsfwanime.json')
let random = anu[Math.floor(Math.random() * anu.length)]
...
/*let message = await prepareWAMessageMedia({ video: { url: random.url }, gifPlayback: true }, { upload: naim.waUploadToServer })
     const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
     templateMessage: {
         hydratedTemplate: {
           videoMessage: message.videoMessage,
           hydratedContentText: 'Nih',
           hydratedFooterText: '© Specstor',
           hydratedButtons: [/*{
urlButton: {
...
await naimi.sendMessage(m.chat, buttonMessage, { quoted: m })*/
let buttonsek = [{
quickReplyButton: {
displayText: 'Next',
id: 'nsfwgif'
...
naimi.sendMessage(from, { caption: 'Nih', video: { url: random.url }, gifPlayback: true, templateButtons: buttonsek, footer: `${setting.botFooter}`, mentions: [sender] })
setTimeout( () => {
 naimi.sendMessage(from, { react: { text: `🥵`, key: m.key }})
}, 10)
confirmlimit(sender, 1)
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
if (!args[0]) return reply(`Mana link nya?\nContoh :\n${prefix}${command} https://github.com/Specstro/tes`)
...
naimi.sendMessage(from, {video:{url:i.url}, caption:`Type : ${i.type}`, mimetype:'video/mp4'}, {quoted:m})
  ...
  try {
    reply(mess.wait)
  naimi.sendMessage(from, {image:{url:args[0]}, caption:' ${setting.botFooter}'}, {quoted:m})
  } catch {
reply("Linknya Error")
}
break
...
naimi.sendMessage(from, { caption: 'Kamu bisa mengubahnya menjadi Vidio Tanpa Watermark atau Audio, pencet tombol dibawah untuk mengubahnya!', video: { url: data.watermark }, templateButtons: bton, footer: `${setting.botFooter}`, mentions: [sender] })
confirmlimit(sender, 1)
})
}
break
...
let media = await y2mate(text, quality)
if (media.filesize >= 999999) return reply('*File Over Limit* '+util.format(media))
let caption = `*「 Youtube Music 」*\n\n*Title :* ${media.title}\n*File size :* ${media.filesizeF}\n*Url :* ${isUrl(text)}\n*Ext :* MP3\n*Resolution :* ${args[1] || '128kbps'}`
buf = await getBuffer(media.thumb)
naimi.sendMessage(m.chat, { image: { url: media.thumb }, jpegThumbnail:buf, caption: `${caption}` }, { quoted: m }).catch((err) => reply(mess.error))                
naimi.sendMessage(m.chat, {audio:{url:media.dl_link}, mimetype:"audio/mpeg", fileName: `${media.title}.mp3`,  quoted: m, contextInfo: { externalAdReply:{title:media.title,body:"YOUTUBE MP3",mediaType:"2",thumbnail:buf,mediaUrl:`${text}`}}}).catch((err) => reply(mess.error))
}
break
case 'ytmp3':{
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
reply(mess.wait)
data = await caliph.downloader.youtube.ytmp4(q)
naimi.sendMessage(m.chat, { video: await getBuffer(data.result), caption: data.title }, { quoted: m })
confirmlimit(sender, 1)
}
break
  case 'getmusic': {
...
karutachi = pinnya
let txt99 = `Result : ${q}`
naimi.send5ButImg(from, txt99, `${setting.botFooter}`, karutachi, btn99)
confirmlimit(sender, 1)
break
case 'couple': {
 if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
const res2 = await wiki(q).catch(e => {
...
await naimi.sendButtonText(m.chat, buttons, '_Kamu tidak sedang berada di anonymous chat_', `${setting.botFooter}`)
    return false
}
...
{ buttonId: 'keluar', buttonText: { displayText: 'Stop' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, '_Menunggu partner..._', `${setting.botFooter}`, m)
}
break
}
...
•Saya Bukan wibu :v`
naimi.sendMessage(m.chat, { video: { url:'https://media.discordapp.net/attachments/964434560077144076/964567803363483668/284370.mov.mp4' }, gifPlayback: true , caption:pro}, { quoted: m })
break
case 'menu':
case 'list':
case 'help':
...
naimi.sendMessage(from, { caption: menulist, image: global.thumb, templateButtons: bton, footer:`${setting.botFooter}`, mentions: [sender] })
} else if (setbot.templateGif) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, gifPlayback: true, templateButtons: bton, footer: `${setting.botFooter}`, mentions: [sender] })
} else if (setbot.templateVid) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, templateButtons: bton, footer: `${setting.botFooter}`, mentions: [sender] })
} else if (setbot.templateVideo) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, templateButtons: bton, footer: `${setting.botFooter}`, mentions: [sender] })
} else if (setbot.templateMsg) {
naimi.sendMessage(from, { text: menulist, templateButtons: buttonsDefault, footer: `${setting.botFooter}`, mentions: [sender] })
...
naimi.sendMessage(m.chat, { caption: menulist, document: fs.readFileSync('./karuta/karuta.xlsx'), mimetype: `${docs}`, jpegThumbnail:fs.readFileSync("./karuta/menu.png"), fileName: `${setting.botName}`, templateButtons: buttonmenu, footer: `${setting.botFooter}`, mentionedJid: [m.sender] })
}
setTimeout( () => {
 naimi.sendMessage(from, { react: { text: `🥶`, key: m.key }})
}, 3000)
